    ...
    return (
      <Container className="text-center">
        ...
        <Row>
          <Col>
            <p>Bear</p>
            <img src={img2} alt="img1" style={{ boxShadow: '0 0 5px 3px #00000042' }} />
          </Col>
          <Col>
            <p>Unicorn</p>
            <img src={img3} alt="img2" style={{ boxShadow: '0 0 5px 3px #00000042' }} />
          </Col>
          <Col>
            <p>Dinosaur</p>
            <img src={img4} alt="img3" style={{ boxShadow: '0 0 5px 3px #00000042' }} />
          </Col>
        </Row><br />
        <h3>Player</h3> <br />
        <Row>
